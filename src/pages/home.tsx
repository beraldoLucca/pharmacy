...
export default function Home(){
    ...
    // if(session){
        ...
        // <div>
          ...
          <Button className={styles.button}>Cadastrar medicamento</Button>
          </Link>
          <br></br>
          ...
          <Button className={styles.button}>Vincular um medicamento a um sid</Button>
          </Link>
          <br></br>
          <Link href="/dateOfMedicineArrival">
          <Button className={styles.button}>Cadastrar chegada de nova remessa de medicamento</Button>
          </Link>
          <br></br>
